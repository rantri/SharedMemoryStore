...
public sealed class DockerSynchronizationIntegrationTests
{
    [Fact]
    [Trait("Category", "Integration")]
    public void DockerContentionProfileValidatesBoundedWaitCancellationAndBusyOutcomes()
    {
        ...
        RunDockerProfile("Contention");
    }

    [Fact]
    [Trait("Category", "Integration")]
    public void DockerDisposalRaceProfileValidatesDocumentedLifecycleOutcomes()
    {
        if (!ShouldRunDockerValidation())
        {
            return;
