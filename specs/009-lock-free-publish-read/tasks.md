...
- [X] T104 Freeze one-shot PR/nightly/release execution at `009-final-r5-pr`, `009-final-r5-nightly`, and `009-final-r5-release` without overwriting preserved diagnostics or rejected earlier final candidates; conditional closure requires matching Windows-x64/Linux-x64 schema-v3 evidence and identical clean commit/source-manifest provenance, entirely machine-derived with no tracked post-run edit
...
| Performance and success criteria SC-001..SC-018 | T039-T041, T045-T046, T055, T073, T075-T117 |
